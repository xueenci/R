...
```{r 链接数据准备,eval=FALSE, include=FALSE}
flights2 <- flights %>% 
...
```{r rif语句, eval=FALSE, include=FALSE}
if (condition) {
...
直接用c()来代表向量的话，比较占用空间，会变慢，所以一般是先创建一个新的向量，vector("类型“，“长度”)
...
```{r fornames, eval=FALSE, include=FALSE}
